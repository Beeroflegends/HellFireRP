	...
	IsDead = false
		...
		ESX.TriggerServerCallback('esx_ambulancejob:getDeathStatus', function(isDead)
			if isDead and Config.AntiCombatLog then
				exports['mythic_notify']:DoHudText('error', _U('combatlog_message'),7000)
...
Citizen.CreateThread(function()
	...
	--[[		DisableControlAction(0, 322, true) -- Disable tilt
			...
			EnableControlAction(0, Keys['9'], true)
...
AddEventHandler('esx_ambulancejob:useItem', function(itemName)
	...
	if itemName == 'medikit' then
			...
			local lib, anim = 'missheistdockssetup1clipboard@idle_a', 'idle_a' -- TODO better animations
	     	local playerPed = PlayerPedId()
 		exports['progressBars']:startUI(6000, "USING MEDKIT")
		...
		ESX.Streaming.RequestAnimDict(lib, function()
			...
			exports['mythic_notify']:DoHudText('success', _U('used_medikit'),7000)				
			--ESX.ShowNotification(_U('used_medikit'))
		end)
 
	elseif itemName == 'bandage' then

				 exports['progressBars']:startUI(7000, "USING BANDAGE")
		...
		ESX.Streaming.RequestAnimDict(lib, function()
			...
			exports['mythic_notify']:DoHudText('success', _U('used_bandage'),7000)
			--ESX.ShowNotification(_U('used_bandage'))
		end)	

	elseif itemName == 'pildora' then
	 
	 	exports['progressBars']:startUI(1500, "TAKING PILLS")
		...
		ESX.Streaming.RequestAnimDict(lib, function()
			...
			exports['mythic_notify']:DoHudText('success', _U('used_pildora'),7000)
...
exports['mythic_notify']:DoHudText('inform', _U('distress_sent'),10000)
