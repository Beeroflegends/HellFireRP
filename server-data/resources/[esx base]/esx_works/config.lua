...
Config.platePrefix                = "Electricista"
Config.Locale                     = 'fr'
...
Config.Zones = {
  ...
  Cloakroom = {
	...
	BlipSprite = 354,
	BlipColor = 46,
	BlipName = 'Electricista',
	hint = 'Presiona ~INPUT_CONTEXT~ para abrir el menú',
  },
  ...
  VehicleSpawner = {
	...
	hint = 'Presiona ~INPUT_CONTEXT~ para abrir el garage',
  },
  ...
  VehicleDeleter = {
	...
	Color = {r = 255, g = 0, b = 0},
	Type  = 1,
	BlipName = Config.nameJobLabel.." : Regresar vehiculo",
	hint = 'Presiona ~INPUT_CONTEXT~ para regresar el vehiculo',
  },
--[[
  Vente = {
...
{ [ 'x' ] = 	 435.78		, [ 'y' ] = 	-974.95		, [ 'z' ] = 	30.72	},
{ [ 'x' ] = 	 338.42		, [ 'y' ] = 	-593.07		, [ 'z' ] = 	28.79	},
