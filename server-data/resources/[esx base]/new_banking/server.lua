...
RegisterServerEvent('bank:deposito')
AddEventHandler('bank:deposito', function(amount)
...
RegisterServerEvent('bank:retirar')
AddEventHandler('bank:retirar', function(amount)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
	local base = 0
