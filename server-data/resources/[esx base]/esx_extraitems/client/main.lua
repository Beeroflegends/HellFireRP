...
AddEventHandler('esx_extraitems:oxygen_mask', function()
	...
	local lib, anim = 'clothingshirt', 'try_shirt_positive_d' -- TODO better animations
		...
		ESX.Streaming.RequestAnimDict(lib, function()
			...
			exports['progressBars']:startUI(10000,"Poniendo equipo")
			Citizen.Wait(500)
	...
	ESX.Game.SpawnObject('p_s_scuba_mask_s', {
		...
		ESX.Game.SpawnObject('p_s_scuba_tank_s', {
			...
			exports['mythic_notify']:DoHudText('inform', 'Te haz puesto el equipo. Oxigeno 100%', 5000, { ['background-color'] = '#00559B', ['color'] = '#ffffff' })
--			ESX.ShowNotification(_U('dive_suit_on') .. '%.')
			Citizen.Wait(250000)
			exports['mythic_notify']:DoHudText('inform', 'Oxigeno al 50%', 9000, { ['background-color'] = '#00559B', ['color'] = '#ffffff' })
			Citizen.Wait(125000)
			exports['mythic_notify']:DoHudText('inform', 'Oxigeno al 25%', 9000, { ['background-color'] = '#00559B', ['color'] = '#ffffff' })
			Citizen.Wait(125000)
			exports['mythic_notify']:DoHudText('inform', 'Oxigeno en 0%', 5000, { ['background-color'] = '#00559B', ['color'] = '#ffffff' })
...
AddEventHandler('esx_extraitems:bulletproof', function()
	...
	local lib, anim = 'clothingshirt', 'try_shirt_positive_d' -- TODO better animations
		...
		ESX.Streaming.RequestAnimDict(lib, function()
			TaskPlayAnim(playerPed, lib, anim, 8.0, -8.0, -1, 0, 0, false, false, false)
			exports['progressBars']:startUI(10000,"Poniendo chaleco")
			Citizen.Wait(500)
			while IsEntityPlayingAnim(playerPed, lib, anim, 3) do
				Citizen.Wait(0)
				DisableAllControlActions(0)
...
RegisterNetEvent('esx_extraitems:chaleco')
AddEventHandler('esx_extraitems:chaleco', function()
	local playerPed = GetPlayerPed(-1)
	local lib, anim = 'clothingshirt', 'try_shirt_positive_d' -- TODO better animations
	...
	SetPedComponentVariation(playerPed, 9, 7, 0, 2)
--	SetPedComponentVariation(playerPed, 9, 27, 9, 2)
	AddArmourToPed(playerPed, 100)
	SetPedArmour(playerPed, 100)
end)
...
AddEventHandler('esx_extraitems:firstaidkit', function()
	local lib, anim = 'anim@heists@narcotics@funding@gang_idle', 'gang_chatting_idle01' -- TODO better animations
		...
		ESX.Streaming.RequestAnimDict(lib, function()
			TaskPlayAnim(playerPed, lib, anim, 8.0, -8.0, -1, 0, 0, false, false, false)
			exports['progressBars']:startUI(11500,"Usando botiquin")
			Citizen.Wait(500)
			while IsEntityPlayingAnim(playerPed, lib, anim, 3) do
				Citizen.Wait(0)
				DisableAllControlActions(0)
			...
			exports['mythic_notify']:DoHudText('success', 'Haz usado un botiquin')
		end)
		end)
...
AddEventHandler("yordi:cleaningcloth", function()
	...
	if SetVehicleDirtLevel(vehicle, 0) then
		exports['mythic_notify']:DoHudText('success', 'Carro limpio')
