TokoVoipConfig = {
	...
	keyProximity = Keys["N"], -- Yakınlık modunu değiştirmek için kullanılan tuş
	...
	plugin_data = {
		...
		TSChannel = "game",
		TSPassword = "1", -- TeamSpeak channel password (can be empty)
		...
		TSChannelWait = "Welcome",

		-- Blocking screen informations
		TSServer = "http://185.126.200.52:1", -- TeamSpeak server address to be displayed on blocking screen
