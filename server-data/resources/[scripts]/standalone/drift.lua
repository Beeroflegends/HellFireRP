...
function DriftOff()
				...
				local removeFromfLowSpeedTractionLossMult = (GetVehicleHandlingFloat(vehicle, "CHandlingData", "fLowSpeedTractionLossMult")+0.60)
				local currentEngineMod = GetVehicleMod(vehicle, 11)
		
					exports['mythic_notify']:DoHudText('inform',' Drift Mode OFF.', 2500, { ['background-color'] = '#00FFFF', ['color'] = '#000000' })
...
function DriftOn()
				...
				local addTofLowSpeedTractionLossMult = (GetVehicleHandlingFloat(vehicle, "CHandlingData", "fLowSpeedTractionLossMult")-0.60)
				
					
		
				    exports['mythic_notify']:DoHudText('inform',' Drift Mode ON. ', 2500, { ['background-color'] = '#00FFFF', ['color'] = '#000000' })			
