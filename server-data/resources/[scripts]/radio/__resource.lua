...
supersede_radio "RADIO_08_MEXICAN" { url = "https://dbn313radio.radioca.st/stream", volume = 0.2, name = "313 DBN Radio" }
supersede_radio "RADIO_09_HIPHOP_OLD" { url = "http://shaincast.caster.fm:16351/listen.mp3?authn6d233550f005f8e77cd61cb656fb54aa", volume = 0.33, name = "4-20 Radio" }
supersede_radio "RADIO_11_TALK_02" { url = "http://www.ophanim.net:9780/;stream.nsv", volume = 0.2, name = "Side Street Radio" }
supersede_radio "RADIO_12_REGGAE" { url = "http://audio-online.net:8014/live", volume = 0.2, name = "Loca FM" }
