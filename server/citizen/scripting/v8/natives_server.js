...
global.CreateObject = function (modelHash, x, y, z, isNetwork, netMissionEntity, dynamic) {
	return _in(0x00000000, 0x2f7aa05c, modelHash, _fv(x), _fv(y), _fv(z), isNetwork, netMissionEntity, dynamic, _r, _ri);
};

global.CreateObjectNoOffset = function (modelHash, x, y, z, isNetwork, netMissionEntity, dynamic) {
	return _in(0x00000000, 0x58040420, _ch(modelHash), _fv(x), _fv(y), _fv(z), isNetwork, netMissionEntity, dynamic, _r, _ri);
};
 ...
 * };
 */
global.CreatePed = function (pedType, modelHash, x, y, z, heading, isNetwork, netMissionEntity) {
	return _in(0x00000000, 0x0389ef71, pedType, _ch(modelHash), _fv(x), _fv(y), _fv(z), _fv(heading), isNetwork, netMissionEntity, _r, _ri);
};
 ...
 * };
 */
global.CreatePedInsideVehicle = function (vehicle, pedType, modelHash, seat, isNetwork, netMissionEntity) {
	return _in(0x00000000, 0x3000f092, vehicle, pedType, _ch(modelHash), seat, isNetwork, netMissionEntity, _r, _ri);
};
 ...
 */
global.GetPlayerMeleeWeaponDamageModifier = function () {
	return _in(0x00000000, 0x8689a825, _r, _rf);
};
