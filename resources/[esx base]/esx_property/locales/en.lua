Locales['en'] = {
  ...
  ['move_out_sold'] = 'sell property for <span style="color:red;">$%s</span>',
  ['moved_out'] = 'you moved out and do no longer rent the property.',
  ['moved_out_sold'] = 'you have sold the property for ~g~$%s~s~',
  ['buy'] = 'buy property for <span style="color:red;">$%s</span>',
  ['buy_for'] = 'you purchased a property for ~g~$%s~s~',
  ['rent'] = 'rent property for <span style="color:red;">$%s</span> / week',
