...
RegisterServerEvent('esx_vehicleshop:setVehiculoOwned')
AddEventHandler('esx_vehicleshop:setVehiculoOwned', function (vehicleProps,vehicleData)
...
RegisterServerEvent('esx_vehicleshop:setVehiculoOwnedPlayerId')
AddEventHandler('esx_vehicleshop:setVehiculoOwnedPlayerId', function (playerId, vehicleProps,vehicleData)
...
RegisterServerEvent('esx_vehicleshop:setVehiculoOwnedSociety')
AddEventHandler('esx_vehicleshop:setVehiculoOwnedSociety', function (society, vehicleProps)
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
