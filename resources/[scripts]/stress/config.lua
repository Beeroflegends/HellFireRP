...
MFS.GetSickAt       = 70 -- only change the first value (percent player gets sick at)
...
MFS.StaticAdder     = 0.4 -- % stress gained over time from things like driving too fast.
MFS.CombatAdder     = 0.4 -- % stress gained while in combat
MFS.ShootingAdder   = 0.3 -- % stress gained while shooting
MFS.StressAtSpeed   = 380 -- kph
