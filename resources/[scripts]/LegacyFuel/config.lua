...
Config.RefillCost = 20 -- If it is missing half of it capacity, this amount will be divided in half, and so on.
...
if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Presiona ~g~E ~w~para tomar un bidón"
