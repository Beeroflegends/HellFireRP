        ...
        for k, v in pairs(Config.KeybindKeys) do
            if IsControlJustReleased(0, v) then
                ...
                if k == keyb6 then if emob6 ~= "" then EmoteCommandStart(nil,{emob6, 0}) end end
				 if k == keyb7 then if emob7 ~= "" then EmoteCommandStart(nil,{emob7, 0}) end end
				  if k == keyb8 then if emob8 ~= "" then EmoteCommandStart(nil,{emob8, 0}) end end
				   if k == keyb9 then if emob9 ~= "" then EmoteCommandStart(nil,{emob9, 0}) end end
                Wait(1000)
            end
        end
    end
...
AddEventHandler("dp:ClientKeybindGet", function(k1, e1, k2, e2, k3, e3, k4, e4, k5, e5, k6, e6, k7, e7, k8, e8, k9, e9)
    keyb1 = k1 emob1 = e1 keyb2 = k2 emob2 = e2 keyb3 = k3 emob3 = e3 keyb4 = k4 emob4 = e4 keyb5 = k5 emob5 = e5 keyb6 = k6 emob6 = e6 keyb7 = k7 emob7 = e7 keyb8 = k8 emob8 = e8 keyb9 = k9 emob9 = e9
    Initialized = true
end)
...
AddEventHandler("dp:ClientKeybindGetOne", function(key, e)
	...
	if key == "num4" then emob1 = e keyb1 = "num4" 
	elseif key == "num5" then emob2 = e keyb2 = "num5" 
	elseif key == "num6" then emob3 = e keyb3 = "num6" 
	elseif key == "num7" then emob4 = e keyb4 = "num7" 
	elseif key == "num8" then emob5 = e keyb5 = "num8" 
	elseif key == "num9" then emob6 = e keyb6 = "num9" 
	elseif key == "z" then emob7 = e keyb7 = "z"
	elseif key == "x" then emob8 = e keyb8 = "x" 
	elseif key == "g" then emob9 = e keyb9 = "g" 
	end
end)
...
function EmoteBindsStart()
    EmoteChatMessage(Config.Languages[lang]['currentlyboundemotes'].."\n"
		...
		..firstToUpper(keyb7).." = '^2"..emob7.."^7'\n"
		..firstToUpper(keyb8).." = '^2"..emob8.."^7'\n"
		..firstToUpper(keyb9).." = '^2"..emob9.."^7'\n") 
